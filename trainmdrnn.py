...
from Generating_data.loaders import RolloutSequenceDataset
from core.models_of_world_model.vae import VAE
from core.models_of_world_model.mdrnn import MDRNN, gmm_loss
...
def to_latent(obs, next_obs):
    ...
    with torch.no_grad():
        obs, next_obs = [
            f.upsample(x.view(-1, 4, SIZE, SIZE), size=RED_SIZE,
