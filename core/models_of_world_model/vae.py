...
class Decoder(nn.Module):
    ...
    def __init__(self, img_channels, latent_size):
        ...
        self.deconv0 = nn.ConvTranspose2d(1024, 128, 4, stride=2)
        self.deconv1 = nn.ConvTranspose2d(128, 128, 4, stride=2)
        ...
        self.deconv5 = nn.ConvTranspose2d(16, img_channels, 3, stride=1)
